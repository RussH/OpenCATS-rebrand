...
<html>
    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <div style="text-align:center;">
            ...
            <div id="poweredCATS">
                <a href="http://www.opencats.org" target="_blank">
                    <img src="../images/CATS-powered.gif" alt="Powered by: OpenCATS - Applicant Tracking System" title="Powered by: OpenCATS - Applicant Tracking System" />
                </a>
            </div>
        </div>
